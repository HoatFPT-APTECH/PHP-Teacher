...
<body>
<?php
//include("inc_Functions.php");//gộp mã lệnh từ một tệp khác vào
require("inc_Functions.php");;//gộp mã lệnh từ một tệp khác vào, nếu không có thì dừng chương trình
Hienthi();//gọi hàm hiển thị tiêu đề
	...
	&&isset($_REQUEST["rong"])==true)
{
	...
	{	
		if($pheptinh=="cv")
			$chuvi = Chuvi($dai,$rong);//gọi hàm tính chu vi
		else if($pheptinh=="dt")
			$dientich = Dientich($dai,$rong);//gọi hàm tính diện tích
	}
}
?>
